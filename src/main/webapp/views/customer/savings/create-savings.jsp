...
<head>
    ...
    <script src="assets/scripts/another/customer/savings/create-savings.js" defer></script>
</head>
    ...
    <div class="vh-100 d-sm-flex justify-content-sm-center align-items-sm-center">
        <div class="m-sm-5 p-5 shadow">
            ...
            <form action="" method="" onsubmit="return validate()">
                ...
                <div class="mb-2">
                    <label name="savings-name" class="form-label">Tên sổ tiết kiệm</label>
                ...
                <div class="mb-2">
                    <label name="renew" class="form-label">Tự động tái tục</label>
                ...
                <div class="d-flex justify-content-sm-end justify-content-center mt-3">
                    <button class="btn btn-primary me-2" formaction="./savings.html">Hủy</button>
                    <button class="btn btn-primary" formaction="./savings.html">Tạo</button>
                </div>
            </form>
