...
<section id="transfer" class="bg-light">
    <div class="vh-100 d-sm-flex justify-content-sm-center align-items-sm-center">
        <div class="m-sm-5 p-5 shadow">
            ...
            <form action="transfer-detail" method="post" onsubmit="">
                ...
                <div id="destination">
                    ...
                    <div class="d-flex justify-content-between">
                        <p>Nội dung</p>
                        <p class="text-end text-wrap" style="width: 20rem;">${transfer.content}</p>
                    </div>
                ...
                <div class="d-grid gap-2">
                    <input name="action" value="transfer-detail" type="hidden">
                    <button class="btn btn-primary" >Tiếp tục</button>
                </div>
            </form>
            <form action="transfer-detail" method="post">
                <div class="d-grid gap-2">
                    <input name="action" value="return-transfer" type="hidden">
