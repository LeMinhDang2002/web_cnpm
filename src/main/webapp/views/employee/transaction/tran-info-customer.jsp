                    ...
                    <div class="mb-2">
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="" id="" class=" form-control text-success" value="${account.numberPhone}" disabled>
                                <input type="hidden" name="account" id="" class=" form-control text-success" value="${account.numberPhone}">
                            </div>
                    ...
                    <div class="mb-2">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" name="lastname" id="lastname" class=" form-control text-success" value="${account.lastname}" disabled>
                            </div>
                        ...
                        <div class="mb-2">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="date" name="dob" id="" class=" form-control text-success" value="${account.dob}" disabled>
                                </div>
                            ...
                            <div class="mb-2">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label for="number-phone" class="form-label">Số điện thoại</label>
                                        <input type="text" name="number-phone" id="" class=" form-control text-success" value="${account.numberPhone}" disabled>
                                    </div>
                        ...
                        <div class="d-flex justify-content-sm-end justify-content-center mt-3">
                            ...
                            <button class="btn btn-primary" name="action" value="tran-info-customer">Tiếp tục</button>
                        </div>
                    </div>
                </div>
            </form>
