...
<section id="payment" class="bg-light">
  <div class="vh-100 d-sm-flex justify-content-sm-center align-items-sm-center">
    <div class="m-sm-5 p-5 shadow">
      ...
      <form action="withdrawal" method="post" onsubmit="">
        ...
        <div id="source">
          ...
          <div class="mb-2">
              ...
              <div class="mb-2">
                <div class="row">
                  <div class="col-sm-6">
                    ...
                    <input type="text" name="phone-number" id="" class=" form-control text-success" value="${account.dob}" disabled>
                  </div>

                  <div class="col-sm-6">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" name="email" id="available-amount" class=" form-control text-success" value="${account.email}" disabled>
                  </div>
            ...
            <div class="d-flex justify-content-sm-end justify-content-center mt-3">
              ...
              <button class="btn btn-primary" name="action" value="withdrawal-info-customer">Tiếp tục</button>
            </div>
          </div>
        </div>
      </form>
