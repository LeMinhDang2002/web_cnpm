...
<nav class="navbar navbar-expand-md sticky-top shadow bg-light">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item"><a href="${pageContext.request.contextPath}" class="nav-link">Trang chủ</a></li>
      ...
      <div class="d-md-flex justify-content-md-end flex-grow-1">
        <div class="d-md-inline d-none dropdown-center">
          ...
          <ul class="dropdown-menu dropdown-menu-end">
            <li><a href="infor_account" class="dropdown-item">Thông tin cá nhân</a></li>
        ...
        <div class="d-md-none d-inline">
          <ul class="navbar-nav">
            <li class="nav-item"><a href="hange-information" class="nav-link">Thông tin cá nhân</a></li>
